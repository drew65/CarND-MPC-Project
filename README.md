...
## Implementation
### The Model
The model was taken from the model defined in the lessons:
...
I dealt with the latency by use previous actuations (i.e. from the previous dt (100 ms behind) when feeding the solver)
